  ...
  return (
    <div className="pt-32 pb-20 sm:pt-36">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <h1 className="mt-3 font-serif text-3xl font-semibold text-mist-950 sm:text-4xl">{title}</h1>
...
export function LegalSection({
  ...
  return (
    <section>
      <h2 className="font-serif text-xl font-semibold text-mist-950">{heading}</h2>
