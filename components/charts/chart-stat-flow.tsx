...
function useNumberFlowElementReady(): boolean {
  // Always start `false` so the server-rendered static value matches the first
  // client paint, then upgrade to the animated element after mount. Seeding this
  // from `customElements.get(...)` (truthy on the client, false on the server)
